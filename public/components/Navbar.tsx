          ...
          <div className="hidden items-center space-x-8 md:flex">
            {navigation.map((item) => (
              ...
              >
                {item.name}
                {isActive(item.path) && (
                  <div className="absolute -bottom-2 left-0 right-0 h-1 rounded-full bg-gradient-to-r from-emerald-600 to-emerald-400 shadow-md" />
                )}
              </Link>
            ))}
          </div>
          ...
          <div className="gradient-divider-top bg-background/95 backdrop-blur md:hidden">
            <div className="space-y-1 px-2 pb-3 pt-2">
              ...
              <div className="border-t pt-2">
                ...
                >
                  <Phone className="h-4 w-4" />
                  <span className="font-main font-medium">
