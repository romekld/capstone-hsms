...
Project LINK delivers a two-tier health information system for CHO 2 Dasmarinas City in 12 phases over a 4-month capstone build.

## Milestones

- ✅ **v2 Foundation** — Phases 1–2 (shipped 2026-03-18)
- 📋 **v3 Clinical Core** — Phases 3–12 (planned)
...
- [ ] **Phase 4: MCH Shared Data Model** — ORM models, Pydantic schemas, and Alembic migration for all four MCH programs (prenatal, postpartum, EPI, nutrition) — schema foundation for Phases 5–7
- [ ] **Phase 5: Prenatal + Postpartum Programs** — Prenatal enrollment/visits/overdue/high-risk flags + postpartum delivery recording with Day 1/Week 1/Week 6 auto-schedule
- [ ] **Phase 6: EPI Vaccination Program** — Dose sequence enforcement, vaccine grid UI, auto-scheduling, defaulter detection, FIC computation
- [ ] **Phase 7: Nutrition / OPT+ Program** — WHO Z-score auto-computation, severe wasting at-risk flag, Vitamin A/iron/deworming eligibility by age band
- [ ] **Phase 8: TB-DOTS + NCD Programs** — TB case management with daily DOTS and sputum tracking, NCD enrollment with PhilPEN risk stratification
- [ ] **Phase 9: Disease Surveillance + Real-Time Alerts** — Category I/II disease cases, WebSocket alerts, PIDSR validation, Category II batch export
- [ ] **Phase 10: GIS Disease Mapping** — Barangay choropleth, purok heatmap, DBSCAN outbreak clustering, disease/date/barangay filters
- [ ] **Phase 11: ML Analytics + FHSIS Reporting** — Prophet forecasting, at-risk classifier, barangay risk index, FHSIS M1/M2/Q1/A1 auto-generation and export
- [ ] **Phase 12: Offline PWA + Inventory + CHO Dashboards** — BHW offline mobile entry, background sync, nurse approval queue, inventory tracking, CHO supervisory dashboards

## Phase Details

### Phase 4: MCH Shared Data Model
...
**Success Criteria** (what must be TRUE):
  ...
  2. `prenatal_enrollments.is_high_risk BOOLEAN`, `epi_enrollments.fic_status BOOLEAN`, and `nutrition_visits.severe_wasting BOOLEAN` are present and ready for Phase 11 ML consumption
  3. Pydantic v2 schemas cover create/update/response for all 8 models
  4. `epi_vaccinations.vaccine` TEXT vs enum question resolved (see PROJECT.md Open Questions)
**Plans**: TBD

Plans:
- [ ] 04-01: TBD

### Phase 5: Prenatal + Postpartum Programs
...
**Success Criteria** (what must be TRUE):
  ...
  2. High-risk auto-flags trigger on BP ≥ 140/90, Hgb < 11 g/dL, para ≥ 5, GDM positive, or manual nurse flag; HIGH RISK badge appears on Prenatal tab only (not patient identity header)
...
### Phase 6: EPI Vaccination Program
...
**Success Criteria** (what must be TRUE):
  ...
  3. FIC indicator computes correctly per BHS per month and is stored on the enrollment record; EPI defaulter list page with sidebar badge works
**Plans**: TBD
...
**Success Criteria** (what must be TRUE):
  ...
  2. WHZ < −3 sets `severe_wasting = TRUE` on the visit record for Phase 11 ML consumption
...
### Phase 9: Disease Surveillance + Real-Time Alerts
...
### Phase 11: ML Analytics + FHSIS Reporting
...
### Phase 12: Offline PWA + Inventory + CHO Dashboards
...
| 4. MCH Shared Data Model | v3 | 0/TBD | Not started | - |
| 5. Prenatal + Postpartum Programs | v3 | 0/TBD | Not started | - |
| 6. EPI Vaccination Program | v3 | 0/TBD | Not started | - |
| 7. Nutrition / OPT+ Program | v3 | 0/TBD | Not started | - |
| 8. TB-DOTS + NCD Programs | v3 | 0/TBD | Not started | - |
| 9. Disease Surveillance + Real-Time Alerts | v3 | 0/TBD | Not started | - |
| 10. GIS Disease Mapping | v3 | 0/TBD | Not started | - |
| 11. ML Analytics + FHSIS Reporting | v3 | 0/TBD | Not started | - |
| 12. Offline PWA + Inventory + CHO Dashboards | v3 | 0/TBD | Not started | - |
