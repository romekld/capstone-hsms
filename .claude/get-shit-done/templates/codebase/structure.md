...
- Usage: Reference from command with `@D:/capstone-hsms/.claude/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to D:/capstone-hsms/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to D:/capstone-hsms/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
