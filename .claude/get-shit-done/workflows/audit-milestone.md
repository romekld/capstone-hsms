...
```bash
INIT=$(node "D:/capstone-hsms/.claude/get-shit-done/bin/gsd-tools.cjs" init milestone-op)
...
```bash
integration_checker_model=$(node "D:/capstone-hsms/.claude/get-shit-done/bin/gsd-tools.cjs" resolve-model gsd-integration-checker --raw)
```
...
node "D:/capstone-hsms/.claude/get-shit-done/bin/gsd-tools.cjs" phases list
```
...
PHASE_INFO=$(node "D:/capstone-hsms/.claude/get-shit-done/bin/gsd-tools.cjs" find-phase 01 --raw)
...
for summary in .planning/phases/*-*/*-SUMMARY.md; do
  node "D:/capstone-hsms/.claude/get-shit-done/bin/gsd-tools.cjs" summary-extract "$summary" --fields requirements_completed | jq -r '.requirements_completed'
done
```
...
```bash
NYQUIST_CONFIG=$(node "D:/capstone-hsms/.claude/get-shit-done/bin/gsd-tools.cjs" config get workflow.nyquist_validation --raw 2>/dev/null)
```
