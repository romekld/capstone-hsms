...
```bash
INIT=$(node "D:/capstone-hsms/.claude/get-shit-done/bin/gsd-tools.cjs" init progress)
...
- `STATE=$(node "D:/capstone-hsms/.claude/get-shit-done/bin/gsd-tools.cjs" state-snapshot)`
...
- Use `summary-extract` for efficient parsing:
  ```bash
  node "D:/capstone-hsms/.claude/get-shit-done/bin/gsd-tools.cjs" summary-extract <path> --fields one_liner
  ```
...
PROGRESS_BAR=$(node "D:/capstone-hsms/.claude/get-shit-done/bin/gsd-tools.cjs" progress bar --raw)
```
