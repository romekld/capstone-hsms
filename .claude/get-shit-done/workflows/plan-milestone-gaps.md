...
PHASES=$(node "D:/capstone-hsms/.claude/get-shit-done/bin/gsd-tools.cjs" phases list)
...
```bash
node "D:/capstone-hsms/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs(roadmap): add gap closure phases {N}-{M}" --files .planning/ROADMAP.md .planning/REQUIREMENTS.md
```
