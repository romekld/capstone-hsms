...
See D:/capstone-hsms/.claude/get-shit-done/templates/discovery.md `<discovery_protocol>` for full protocol.
</source_hierarchy>
...
6. **Create DISCOVERY.md** using D:/capstone-hsms/.claude/get-shit-done/templates/discovery.md structure:
...
1. **Scope the discovery** using D:/capstone-hsms/.claude/get-shit-done/templates/discovery.md:
...
6. **Create comprehensive DISCOVERY.md:**
   ...
   - Full structure from D:/capstone-hsms/.claude/get-shit-done/templates/discovery.md
...
Use D:/capstone-hsms/.claude/get-shit-done/templates/discovery.md.
