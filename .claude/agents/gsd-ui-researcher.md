...
Use template from `D:/capstone-hsms/.claude/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `D:/capstone-hsms/.claude/get-shit-done/templates/UI-SPEC.md`
...
```bash
node "D:/capstone-hsms/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs($PHASE): UI design contract" --files "$PHASE_DIR/$PADDED_PHASE-UI-SPEC.md"
```
