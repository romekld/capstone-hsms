...
Reference full template: `D:/capstone-hsms/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `D:/capstone-hsms/.claude/get-shit-done/templates/state.md`.
